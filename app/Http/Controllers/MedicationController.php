...
class MedicationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('medication.medication',['medics'=>$medics]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $medics->by = Auth::guard('web')->user()->name;
        $medics->save(); //persist the data
        $medics = Medication::get();
        return view('medication.medication',['medics'=>$medics])->with('successMsg','Record Added Successfully');
    ...
    public function edit($id)
    {
        ...
        return view('medication.edit',['medics'=> $medics]);
    }
    ...
    public function update(Request $request)
    {
        ...
        $medics = Medication::get();
        return view('medication.medication',['medics'=>$medics])->with('successMsg','Record Updated Successfully');
    }
